...
export const en: Messages = {
  ...
  'trend.drawdown.hint.recovered':
    'From the peak on {peak} to the trough on {trough}: {days}. Recovered on {recovery}, after another {back}.',
  'trend.drawdown.hint.open':
    'From the peak on {peak} to the trough on {trough}: {days}, not recovered yet.',
  'trend.episodes.heading': 'Falls and recoveries',
  'trend.episodes.note':
    'Counting the falls over {depth}, {ratio} of the deepest one. Deepest first.',
  'trend.episodes.count': 'Number of falls',
  'trend.episodes.count.hint.open': 'The last one has not been recovered yet.',
  'trend.episodes.count.hint.closed': 'All of them recovered.',
  'trend.episodes.typical': 'Typical length',
  'trend.episodes.typical.hint': 'Median peak to recovery, over the falls that recovered.',
  'trend.episodes.longest': 'The longest',
  'trend.episodes.longest.hint.recovered': 'Bottomed out on {trough}, recovered on {recovery}.',
  'trend.episodes.longest.hint.open': 'Bottomed out on {trough}, not recovered yet.',
  'trend.episodes.column.peak': 'From the peak',
  'trend.episodes.column.trough': 'To the trough',
  'trend.episodes.column.depth': 'Depth',
  'trend.episodes.column.fallDays': 'Length',
  'trend.episodes.column.recovery': 'Recovered on',
