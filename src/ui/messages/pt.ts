...
export const pt: Messages = {
  ...
  'trend.drawdown.hint.recovered':
    'Do máximo a {peak} até ao mínimo a {trough}: {days}. Recuperada a {recovery}, após mais {back}.',
  'trend.drawdown.hint.open':
    'Do máximo a {peak} até ao mínimo a {trough}: {days}, ainda não recuperada.',
  'trend.episodes.heading': 'Quedas e recuperações',
  'trend.episodes.note':
    'São contadas as quedas acima de {depth}, {ratio} da mais profunda. Da mais profunda para a menos.',
  'trend.episodes.count': 'Número de quedas',
  'trend.episodes.count.hint.open': 'A última ainda não foi recuperada.',
  'trend.episodes.count.hint.closed': 'Todas recuperadas.',
  'trend.episodes.typical': 'Duração típica',
  'trend.episodes.typical.hint': 'Mediana do máximo à recuperação, sobre as quedas recuperadas.',
  'trend.episodes.longest': 'A mais longa',
  'trend.episodes.longest.hint.recovered': 'Mínimo a {trough}, recuperada a {recovery}.',
  'trend.episodes.longest.hint.open': 'Mínimo a {trough}, ainda não recuperada.',
  'trend.episodes.column.peak': 'Do máximo',
  'trend.episodes.column.trough': 'Ao mínimo',
  'trend.episodes.column.depth': 'Profundidade',
  'trend.episodes.column.fallDays': 'Duração',
  'trend.episodes.column.recovery': 'Recuperada a',
  'trend.episodes.column.recoveryDays': 'Em',
  ...
  'trend.bestDay': 'Melhor dia',
  'trend.bestDay.hint': 'Ganho registado a {date}.',
