...
export const it = {
  ...
  'trend.drawdown.hint.recovered':
    'Dal picco del {peak} al minimo del {trough}: {days}. Recuperata il {recovery}, dopo altri {back}.',
  'trend.drawdown.hint.open':
    'Dal picco del {peak} al minimo del {trough}: {days}, non ancora recuperata.',
  'trend.episodes.heading': 'Discese e recuperi',
  'trend.episodes.note':
    'Sono contate le discese oltre {depth}, il {ratio} della più profonda. In ordine di profondità.',
  'trend.episodes.count': 'Numero di discese',
  'trend.episodes.count.hint.open': "L'ultima non è ancora rientrata.",
  'trend.episodes.count.hint.closed': 'Tutte rientrate.',
  'trend.episodes.typical': 'Durata tipica',
  'trend.episodes.typical.hint': 'Mediana dal picco al recupero, sulle discese rientrate.',
  'trend.episodes.longest': 'La più lunga',
  'trend.episodes.longest.hint.recovered': 'Minimo toccato il {trough}, rientrata il {recovery}.',
  'trend.episodes.longest.hint.open': 'Minimo toccato il {trough}, non ancora rientrata.',
  'trend.episodes.column.peak': 'Dal picco',
  'trend.episodes.column.trough': 'Al minimo',
  'trend.episodes.column.depth': 'Profondità',
  'trend.episodes.column.fallDays': 'Durata',
  'trend.episodes.column.recovery': 'Recuperata il',
  'trend.episodes.column.recoveryDays': 'In quanto',
