...
export const es: Messages = {
  ...
  'summary.return.hint': 'Todo el periodo, de {from} a {to}. En total, no al año.',
  'summary.returnUnavailable': 'Rentabilidad no disponible: el capital neto aportado es cero.',
  'summary.annualReturn': 'Rentabilidad anual',
  'summary.annualReturn.hint':
    'Tasa interna de retorno: lo que ha rendido de media al año cada euro, durante el tiempo que estuvo realmente en la cuenta. Las posiciones abiertas se valoran a coste de adquisición, no a precio de mercado, así que la cifra es prudente.',
  'summary.annualReturn.unavailable':
    'Una tasa anual necesita al menos {days} días de historial y al menos una aportación.',
  ...
  'trend.bestDay': 'Mejor día',
  'trend.bestDay.hint': 'Ganancia registrada el {date}.',
  ...
  'capital.noCapital': 'En el periodo no había capital invertido.',
  'capital.basis':
    'Estas dos cifras son un solo cálculo: compraventas y dividendos en bruto, divididos por el capital que estuvo realmente en riesgo. La rentabilidad sobre el capital del resumen mide otra cosa — beneficio neto de gastos y retenciones, dividido por todo el dinero aportado — así que los dos porcentajes no son comparables. Aquí no hay una tasa anual: está en el resumen, donde es una tasa interna de retorno y no este porcentaje dividido por los años.',
