...
export const nl: Messages = {
  ...
  'trend.drawdown.hint.recovered':
    'Van de top op {peak} tot het dieptepunt op {trough}: {days}. Hersteld op {recovery}, na nog eens {back}.',
  'trend.drawdown.hint.open':
    'Van de top op {peak} tot het dieptepunt op {trough}: {days}, nog niet hersteld.',
  'trend.episodes.heading': 'Dalingen en herstel',
  'trend.episodes.note':
    'Geteld worden de dalingen boven {depth}, {ratio} van de diepste. Diepste eerst.',
  'trend.episodes.count': 'Aantal dalingen',
  'trend.episodes.count.hint.open': 'De laatste is nog niet hersteld.',
  'trend.episodes.count.hint.closed': 'Allemaal hersteld.',
  'trend.episodes.typical': 'Typische duur',
  'trend.episodes.typical.hint': 'Mediaan van top tot herstel, over de herstelde dalingen.',
  'trend.episodes.longest': 'De langste',
  'trend.episodes.longest.hint.recovered': 'Dieptepunt op {trough}, hersteld op {recovery}.',
  'trend.episodes.longest.hint.open': 'Dieptepunt op {trough}, nog niet hersteld.',
  'trend.episodes.column.peak': 'Vanaf de top',
  'trend.episodes.column.trough': 'Tot het dieptepunt',
  'trend.episodes.column.depth': 'Diepte',
  'trend.episodes.column.fallDays': 'Duur',
  'trend.episodes.column.recovery': 'Hersteld op',
  ...
  'trend.bestDay': 'Beste dag',
  'trend.bestDay.hint': 'Winst behaald op {date}.',
